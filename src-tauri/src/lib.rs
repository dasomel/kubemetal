...
use commands::colima::{
    ...
    start_cluster, stop_cluster, trigger_airgap_download, trigger_airgap_install, ColimaState,
};
...
use commands::local_inference_bridge::{
    get_local_inference_bridge_status, start_local_inference_bridge, stop_local_inference_bridge,
    LocalInferenceBridgeState,
};
use commands::local_inference_cache::{
    cleanup_local_inference_cache, inspect_local_inference_cache,
};
...
use commands::mlx::{
    ...
    run_mlx_finetune, setup_mlx_env, start_model_serving, stop_model_serving,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            preflight_local_inference_model_load,
            evaluate_local_inference_cache_compatibility,
